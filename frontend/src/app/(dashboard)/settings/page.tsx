...
export default function SettingsPage() {
  ...
  const sections = [
    ...
    {
      icon: Brain, title: "SRS Algorithm",
      toggles: [
  ...
  return (
    <div className="p-6 space-y-5 max-w-2xl">
      <div>
        <h1 style={{ color: "#111827", marginBottom: "4px", fontSize: "22px", fontWeight: 700 }}>Settings</h1>
      ...
      <div className="bg-white rounded-xl p-5 flex items-center gap-4" style={{ border: "1px solid #e5e7eb" }}>
        <div className="w-14 h-14 rounded-full flex items-center justify-center text-white"
          style={{ background: "#1a3a2a", fontSize: "20px", fontWeight: 700 }}>A</div>
        <div>
        ...
        <button className="ml-auto px-4 py-2 rounded-lg"
          style={{ fontSize: "13px", fontWeight: 600, background: "#1a3a2a", color: "#fff" }}>
          Edit Profile
        </button>
      </div>
          ...
          <div className="px-5 py-4 space-y-4">
            {items?.map(({ label, type, value }) => (
              <div key={label}>
                ...
                <input type={type} defaultValue={value} className="w-full px-3 py-2 rounded-lg outline-none"
        ...
        <div className="px-5 py-4">
          ...
          <div className="flex gap-3">
            {["Light", "Dark", "System"].map(t => (
              <button key={t} className="flex-1 py-2 rounded-lg transition-all duration-150"
                style={{ fontSize: "13px", fontWeight: t === "Light" ? 600 : 500,
                  background: t === "Light" ? "#1a3a2a" : "#f3f4f6",
                  color: t === "Light" ? "#fff" : "#6b7280", border: "1px solid transparent" }}>
                {t}
              </button>
            ))}
          </div>
      ...
      <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #fecaca" }}>
        ...
        <div className="px-5 py-4 flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-lg"
            style={{ fontSize: "13px", fontWeight: 600, background: "#fef2f2", color: "#dc2626", border: "1px solid #fecaca" }}>
            Delete Account
          </button>
        </div>
      </div>
