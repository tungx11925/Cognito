...
export function DashboardView() {
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 style={{ color: "#111827", marginBottom: "4px" }}>Dashboard</h1>
          ...
          {upcomingReviews.map((row, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <button className="flex items-center gap-1 px-3 py-1.5 rounded-lg" style={{ fontSize: "12px", fontWeight: 600, background: row.due > 0 ? "#1a3a2a" : "#f3f4f6", color: row.due > 0 ? "#fff" : "#9ca3af" }}>
