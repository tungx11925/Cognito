  ...
  return (
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 style={{ color: "#111827", marginBottom: "4px" }}>My Library</h1>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="flex items-center gap-2 px-3 py-2 rounded-lg" style={{ fontSize: "12.5px", fontWeight: 500, color: "#6b7280", background: "#fff", border: "1px solid #e5e7eb" }}>
