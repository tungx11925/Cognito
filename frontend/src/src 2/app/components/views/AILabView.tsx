...
export function AILabView() {
  ...
  return (
    <div className="p-6 space-y-5">
      <div>
        <h1 style={{ color: "#111827", marginBottom: "4px" }}>AI Lab</h1>
      ...
      <div className="grid grid-cols-2 gap-5">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg" style={{ fontSize: "12px", fontWeight: 600, background: "#1a3a2a", color: "#fff" }}>
              ...
              {generatedPreview.map((card, i) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3 mb-2">
                    ...
                    <span className="flex-shrink-0 px-2 py-0.5 rounded-full" style={{ fontSize: "10px", fontWeight: 700, background: "#f0fdf4", color: "#16a34a", border: "1px solid #bbf7d0" }}>
                      {card.confidence}%
                    </span>
                  </div>
