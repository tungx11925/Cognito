...
const decks = [
  {
    ...
    description: "Complexity analysis, Dynamic Programming, and Graph Theory essentials.",
    mastery: 68,
    dueCount: 42,
    status: "due" as const,
  },
  {
    ...
    description: "TCP/IP protocols, encryption standards, and common vulnerability patterns.",
    mastery: 92,
  ...
  },
  {
    id: 3,
    title: "System Design",
    description: "Scalability principles, microservices architecture, and load balancing.",
    mastery: 24,
    dueCount: 12,
    status: "due" as const,
  },
  {
    ...
    description: "Linear algebra, statistics, and basic machine learning models in Python.",
    mastery: 100,
    ...
    <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5" style={{ background: "#f3f4f6" }}>
      ...
      >
        ...
        <div
          ...
          style={{ background: "#1a3a2a", minHeight: "140px" }}
        >
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              <Brain size={13} style={{ color: "#86efac" }} />
              <span style={{ fontSize: "11px", fontWeight: 700, color: "#86efac", letterSpacing: "0.07em" }}>
                SRS MASTERY BOARD
              </span>
            </div>
            <p style={{ color: "#f0fdf4", marginBottom: "6px" }}>
              You have{" "}
              <span style={{ fontWeight: 700, textDecoration: "underline", textDecorationColor: "#86efac" }}>
                142 cards
              </span>{" "}
        ...
        {/* Weekly streak card */}
        <div
          className="rounded-xl p-5 flex-shrink-0 bg-white"
          style={{ border: "1px solid #e5e7eb", minWidth: "220px" }}
        >
          <div className="flex items-center gap-2 mb-1">
            <Flame size={13} style={{ color: "#ea580c" }} />
            <span style={{ fontSize: "11px", fontWeight: 700, color: "#ea580c", letterSpacing: "0.07em" }}>
              WEEKLY STREAK
            </span>
          </div>
          <p style={{ fontSize: "11.5px", color: "#9ca3af", marginBottom: "12px" }}>
            Maintaining consistency for 12 days
          </p>
          <StreakChart />
        </div>
      </motion.div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-1 p-1 rounded-lg bg-white" style={{ border: "1px solid #e5e7eb" }}>
            {["grid", "list"].map((v) => (
              <button
                key={v}
                className="p-1.5 rounded-md transition-all duration-150"
                style={{ color: v === "grid" ? "#1a3a2a" : "#d1d5db", background: v === "grid" ? "#e8f0eb" : "transparent" }}
              >
                {v === "grid" ? (
            ...
            >
              ...
              <div className="text-center">
                ...
                <div style={{ fontSize: "11.5px", color: "#9ca3af", lineHeight: 1.5 }}>
                  Upload a PDF or paste notes to auto-generate cards
                </div>
              </div>
...
export default function App() {
  const [activeNav, setActiveNav] = useState("ailab");

  const renderContent = () => {
    switch (activeNav) {
      case "dashboard": return <DashboardView />;
      case "library": return <LibraryView />;
      case "ailab": return <FlashcardsView />;
      case "sessions": return <SessionsView />;
      case "settings": return <SettingsView />;
      default: return <FlashcardsView />;
    }
  };
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{ background: activeNav === "ailab" ? "#f3f4f6" : "#f3f4f6" }}
          >
            {renderContent()}
          </motion.div>
        </AnimatePresence>
